...
Promise.all([
  ...
  subgroupLayer = L.geoJSON(geojson, {
    ...
    onEachFeature: (feature, layer) => {
      ...
      const p = feature.properties;
      let flagHtml = '';
      if (p.flag === 'lower') flagHtml = '<span class="flag-lower">⚠ Reference AGBD lower than non-reference (note: corrected raster used)</span>';
      else if (p.flag === 'similar') flagHtml = '<span class="flag-similar">~ Reference AGBD similar to non-reference (note: corrected raster used)</span>';
